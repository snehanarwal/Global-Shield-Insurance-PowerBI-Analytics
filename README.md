...
All core metrics were authored as explicit DAX measures inside a dedicated `_Measures` table:
...
// Financial Profitability Metric
...
Settlement Rate % = 
DIVIDE(
    COUNTROWS(FILTER(Fact_claims, Fact_claims[SettlementDays] > 0)),
